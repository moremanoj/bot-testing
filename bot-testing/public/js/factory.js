SampleApplicationModule.factory('CagtegoryFactory', function($http, $q, $timeout){
  var CagtegoryFactory = new Object();


  CagtegoryFactory.getcategory = function(i) {
    var catdata = $q.defer();
    var cat;
    ...
    return catdata.promise
  }

  return CagtegoryFactory;
});
