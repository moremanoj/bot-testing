! function(a, b) {
    ...
    angular.module("textAngularSetup", []).constant("taRegisterTool", d).value("taTools", e).value("taOptions", {
            ...
            keyMappings: [],
            toolbar: [
                ["h3", "p", "bold", "italics", "underline", "strikeThrough", "ul", "ol", "redo", "undo", "clear", "insertLink", "charcount"]
            ],
            classes: {
                focussed: "focussed",
                toolbar: "btn-toolbar",
            ...
            angular.forEach(["h1", "h2", "h3", "h4", "h5", "h6"], function(b) {
                ...
                display: '<div id="toolbarCC" style="display:block; min-width:120px;">Tecken: <span ng-bind="charcount"></span></div>',
                disabled: !0,
                charcount: 2000,
                activeState: function() {
                    //console.log(this.$editor().displayElements.forminput[0].formAction);

                    if (this.$editor().displayElements.forminput[0].formAction=='http://localhost:7575/#/content/news' || this.$editor().displayElements.forminput[0].formAction=='http://node.fountaintechies.com:7575/#/content/news' )
                    { 
                        var a = this.$editor().displayElements.text,
                        b = a[0].innerText || a[0].textContent,
                        c = b.replace(/(\r\n|\n|\r)/gm, "").replace(/^\s+/g, " ").replace(/\s+$/g, " ").length;
                        return this.charcount = 2000 - c, this.$editor().charcount = c, !1;
                    }
                    else
                    {
                        var a=this.$editor().displayElements.text,
